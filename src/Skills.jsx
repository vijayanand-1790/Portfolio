...
const Skills = () => {
  ...
  return (
    <div id='skills' className='bg-neutral-200 text-black overflow-x-hidden'>

      <div className='max-w-7xl mx-auto flex flex-col justify-center items-center md:px-5 lg:px-0 px-4 md:pb-25'>

        <h2 className='text-black md:text-6xl text-4xl font-bold text-center'>My Skills</h2>
        ...
        <motion.div
          ...
          className='md:w-[80%] w-[100%] md:mt-7 mt-3 '>
          ...
          <div className=' flex flex-col gap-1'>
            ...
            <div
              ...
              <span className='w-full h-2 bg-neutral-400 inline-flex rounded'>

                <motion.span
                  initial={{ x: "-100%", opacity: 0 }}
                  whileInView={{ x: 0, opacity: 1 }}
                  transition={{ duration: 1, delay: 0.3 }}
                  className=' w-[80%] h-full bg-blue-600 relative rounded'>
            ...
            <div
              ...
              <span className='w-full h-2 bg-neutral-400 inline-flex rounded'>
                ...
                <motion.span
                  ...
                  whileInView={{ x: 0, opacity: 1 }}
                  transition={{ duration: 1, delay: 0.3 }}
                  className=' w-[50%] h-full bg-blue-600 relative rounded'>
                  <span className='absolute right-0 -top-8'>50%</span>
            ...
            <div
              ...
              <span className='w-full h-2 bg-neutral-400 inline-flex rounded'>
                ...
                <motion.span
                  ...
                  whileInView={{ x: 0, opacity: 1 }}
                  transition={{ duration: 1, delay: 0.3 }}
                  className=' w-[70%] h-full bg-blue-600 relative rounded'>
            ...
            <div
              ...
              <span className='w-full h-2 bg-neutral-400 inline-flex rounded'>
                ...
                <motion.span
                  ...
                  whileInView={{ x: 0, opacity: 1 }}
                  transition={{ duration: 1, delay: 0.3 }}
                  className=' w-[75%] h-full bg-blue-600 relative rounded'>
