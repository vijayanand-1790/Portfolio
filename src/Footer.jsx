	...
	return (
		<div className='text-white bg-black overflow-x-hidden'>
			...
			<div className='max-w-7xl mx-auto pt-20 pb-15'>
					...
					<div className='flex flex-col md:pb-0 pb-5'>
						<h2 className='text-2xl font-bold md:pb-5 pb-2'>Links</h2>
						{
							data.map((item) =>
								...
								<ul key={item.id} className='text-lg hover:text-blue-600 duration-400 cursor-pointer md:pb-3 pb-1'>
				...
				<p className='mt-18 lg:text-lg md:text-base text-sm md:px-4 px-3'>Copyright &copy;2025 All Rights Reserved | Created by<span className='text-blue-600 px-2'>Vijay Anand</span>with React and Tailwind CSS  </p>
